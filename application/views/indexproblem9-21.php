...
<head>
  ...
  <?php $this->load->view('stats_css.php') ?>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.opp-record').on('click', function(){ // SHOWS INDIVIDUAL STATS WHEN NAME IS CLICKED
				$.post( 
					$(this).attr('action'),
					$(this).serialize(),
					function(data){
			...
			<div class="tab-content"> <!--MOST PAGE CONTENT IS UNDER THIS TAB CLASS-->
			  	<div class="tab-pane active" id="home"><!--SINGLES TAB -->
						...
						<table class='table table-striped table-condensed table-standings'>
							<thead>
								<tr>
									...
									<th>Avg. Score</th>
									<th><abbr title="Opponents' average score">Opp Avg. Score</abbr></th>						
								</tr>
							</thead>
							<tbody>				
					...
					<!-- <div class='row singles'> -->
						<form action='stats_controller/score_process' method='post' id='frm'>
							<h3>Input Scores</h3>
							<div>
								<div class="select">
									
										<label for="combobox" class="">Winner</label>
									  <select name='team1' id="combobox">
								...
								<div class="select" >
									  ...
									  <select name='team2' id="combobox2">
									    <option value="">Select one...</option>
									    <?php foreach($players as $player)
										{ ?>
											<option value='<?= $player['first_name'] ?>'><?= $player['first_name'] ?></option>				
							...
							<div>
								<div class="select">
									  ...
									  <select id="combobox3" name='score1'>
								...
								<div class="select">
									  ...
									  <select id="combobox4" name='score2'>
