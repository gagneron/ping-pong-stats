...
<head>
	...
	<style type="text/css">
		.container{min-height:1000px; padding:10px;}
		.main-page{margin-left:20px;  width:1140px;}
		.bordered{border:1px solid lightgray;}
		.navbar{background-color:#273D7E; margin:0;}
		h2{color:white; padding-left:20px;}
		.btn-xs{float:right;}
		.td{text-align:right; min-width:60px;}
		...
		.table-standings th{vertical-align:center; min-width: 60px;}
		.box{ overflow: auto;}
		.box2{overflow:auto; width:100%;}
		
		/*.float-lefty{float:left;}*/
		#small-div, #fake-table{width:0px; border:1px solid black; margin-left:0px; margin-right:0px;}
		.delete{display:none;}
		/*.table{width:auto;}*/
	...
	<div class='container'>
		...
		<div class='main-page'><!--used to give left margin without affecting navbar's margin -->
			<div class='row'>
				...
				<div class='col-xs-2 col-xs-offset-1 add-player'>
...
<!-- start of input scores -->
			...
			<div class='stiff'>
				<div class='row doubles' style='position:absolute; width:86%;'>
